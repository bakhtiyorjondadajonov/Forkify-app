...
const controlRecipe = async ()=>{
    try {
        ...
        _resultsViewDefault.default.renderer(_model.getSearchResultsPerPage());
        _bookmarksViewDefault.default.renderer(_model.state.bookMarks);
        await _model.loadRecipe(id);
        _recipeViewDefault.default.renderer(_model.state.recipe);
    } catch (error) {
        _recipeViewDefault.default.rendorError(error);
    }
};
const controlSearch = async ()=>{
    ...
    //load search results
    _resultsViewDefault.default.renderer(_model.getSearchResultsPerPage());
    _paginationViewDefault.default.renderer(_model.state.search);
};
const controlPagination = (dataGoto)=>{
    _resultsViewDefault.default.renderer(_model.getSearchResultsPerPage(dataGoto));
    _paginationViewDefault.default.renderer(_model.state.search);
};
const controlServings = (newServings)=>{
    _model.updateServingsFn(newServings);
    _recipeViewDefault.default.renderer(_model.state.recipe);
};
...
const init = function() {
    _recipeViewDefault.default.addHandlerRendorer(controlRecipe);
    _searchViewDefault.default.searchFnHandler(controlSearch);
    _paginationViewDefault.default.paginationHandler(controlPagination);
    _recipeViewDefault.default.servingsHandler(controlServings);
    _recipeViewDefault.default.bookMarkHandler(controlBookMarks);
};
init();

},{"url:../img/icons.svg":"loVOp","./model":"Y4A21","./view/bookmarksView":"uOrlR","./view/paginationView":"9Reww","./view/recipeView":"7Olh7","./view/resultsView":"46Nfk","./view/searchView":"blwqv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
parcelHelpers.export(exports, "updateServingsFn", ()=>updateServingsFn
);
...
const state = {
    ...
    search: {
        results: [],
        page: 1,
        resPerPage: _config.RES_PER_PAGE
    }
};
...
const updateServingsFn = (newServings)=>{
...
},{"url:../../img/icons.svg":"loVOp","./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4wVyX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Reww":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends _view.View {
    ...
    _currentPage = 0;
    _generateMarkup() {
        const numberOfPages = Math.ceil(this._data.results.length / this._data.resPerPage);
        this._currentPage = this._data.page;
        if (this._currentPage === 1 && numberOfPages > 1) return this._btnNextRendorer();
        if (this._currentPage === numberOfPages && numberOfPages > 1) return this._btnPreviewRendorer();
        if (this._currentPage < numberOfPages) return `${this._btnPreviewRendorer()}${this._btnNextRendorer()}`;
        return '';
    }
    _btnPreviewRendorer() {
        return `
    <button class="btn--inline pagination__btn--prev" data-goto="${this._currentPage - 1}">
    ...
    <button class="btn--inline pagination__btn--next"  data-goto="${this._currentPage + 1}">
            <span>Page${this._currentPage + 1}</span>
            <svg class="search__icon">
...
},{"url:../../img/icons.svg":"loVOp","./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7Olh7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"loVOp","./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"46Nfk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _view = require("./view");
class SearchView extends _view.View {
...
},{"url:../../img/icons.svg":"loVOp","./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire7e89")
